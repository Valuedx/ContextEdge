...
| [19-playbook-editing.md](./19-playbook-editing.md) | Draft-mutable playbook editing: published versions stay frozen, current/top version is main, embeddings and runtime keep serving the last approved content |
